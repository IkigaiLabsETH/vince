...
**Relationship to other teammate files:** IDENTITY = *who* the agent is. SOUL = *how* it thinks and communicates. USER = *who* it's working for. TOOLS = what it uses. MEMORY = what it retains.
