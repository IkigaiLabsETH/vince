...
I remember the winter of 2018 vividly. That bear market tested everything—my resolve, my thesis, my sleep. Fast forward to December 2025, and I’m seeing similar patterns in AI stocks. NVIDIA’s chart looks like BTC in 2021: parabolic gains built on dreams of infinite compute. I can’t ignore the red flags.
...
NVIDIA ticks at $183, up astronomically from its 2023 split-adjusted lows.
...
Wang’s quip about “fewer conversations” for faster decisions lands with ironic punch, given Big Tech’s notorious bureaucracy. It’s a compelling narrative. Meta’s Llama models dominate open-source benchmarks, positioning the company as a democratizer of AI. Yet, hiring surges in core areas suggest this isn’t pure efficiency—it’s a refocus amid competitive heat.

As an investor, skepticism is warranted. AGI timelines scatter wildly. Expert surveys peg 50% odds by 2031, with optimists whispering 25% by 2027 and conservatives eyeing 2040 or beyond.
...
Yet, the contrarian in me pauses. Risks abound: Launch failures, orbital debris accumulation, solar flares zapping silicon. Earth-based builds remain cheaper for most use cases. Starcloud’s valuation stays opaque, but in a market where AI/ML claims two-thirds of U.S. deal value, hype propels it.

Crunch the growth: Data center power demand could nearly double globally by 2030, from 267 TWh to 493 TWh in Asia-Pacific alone.

AI drives much of this—Goldman Sachs forecasts a 165% surge by decade’s end.
...
The synergy tantalizes: Quantum computing amplifies AI, enabling exponential speedups in optimization, dataset unraveling, even simulating quantum brain effects for AGI. It’s narrative gold, positioning Google as the vanguard.

Reality intrudes. Error rates hobble scaling; quantum supremacy remains elusive for broad tasks. Google’s $3.8 trillion cap embeds these miracles prematurely, with shares at $309.78.

If quantum unlocks AGI, rewards cascade. But ethical shadows—encryption vulnerabilities, access disparities—invite scrutiny. Regulations could clip wings, much like crypto’s SEC battles.

Arithmetic: McKinsey projects $6.7 trillion in global data center investments by 2030 to meet compute demands.
...
NVIDIA reigns as AI’s pick-and-shovel play. GPUs power the revolution, margins plump, demand insatiable. Shares up solidly year-to-date, market cap ballooning to $4.5 trillion, forward P/E around 45x. Backlogs stretch quarters; enthusiasts tout unbreakable moats. Then Peter Thiel drops the hammer. His fund dumped every NVIDIA share in Q3 2025—over 538,000, worth $94 million at the time.

A contrarian signal from a master spotter of bullshit.
...
In crypto parallels: Early GPU mining gave way to ASICs, consolidating power and squeezing margins. NVIDIA profited initially, but specialization disrupted.

I’m not anti-AI, but layered players win long-term: Google’s cloud prowess, Amazon’s inference dominance, Microsoft’s Azure-Copilot integrations. They control the stack, much like Ethereum’s ecosystem outlasted pure miners.

Advice: Trim NVIDIA to a sliver. Reallocate to integrators for resilience. Arithmetic: At current multiples, NVIDIA needs 30%+ annual growth to justify prices—plausible short-term, risky if compute commoditizes.

**The Big Picture: AI vs. Bitcoin – Lessons in Hype and Reality**
