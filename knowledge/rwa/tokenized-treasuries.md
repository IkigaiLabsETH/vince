...
- Issuer: BlackRock USD Institutional Digital Liquidity Fund (BVI)
- Legal: Reg D (U.S. Qualified Purchasers) | Min: $5M USDC
- Fee: 0.20-0.50% management | Custodian: Bank of New York Mellon
- Significance: Largest tokenized fund globally. Institutional benchmark. Securitize as transfer agent.

**Hashnote USYC** — $1.62B AUM | 3.19% yield | 3 chains
- Bermuda-domiciled | Reg S (non-U.S.) | Min: $100K USDC
- Accumulating NAV token. Used as collateral in DeFi protocols.

**Ondo USDY** — $1.29B AUM | 3.49% yield | 12 chains
- U.S. entity | Reg S (non-U.S.) | Min: $1 USDC
- Lowest minimum investment among major products. Rebasing and accumulating variants.
- Widest chain deployment. Strong DeFi composability.

**Franklin Templeton BENJI** — $897M AUM | 3.50% yield | 10 chains
- U.S. registered (Form N-1A) | U.S. retail + institutional | Min: $20
- First SEC-registered mutual fund on public blockchain (Stellar, then Ethereum, Polygon, etc.)
- Fee: 0.15% management

**Superstate USTB** — $778M AUM | 3.01% yield | 3 chains
- Reg D Rule 506(c) | U.S. Qualified Purchasers + Accredited | Min: $100K
- Fee: 0.15% management

**Ondo OUSG** — $717M AUM | 3.28% yield | 4 chains
- BVI structure | U.S. Qualified Purchasers | Min: $100K
- Invests primarily in BUIDL. Instant redemptions via Ondo's infrastructure.

**WisdomTree WTGXX** — $731M AUM | 3.51% yield | 9 chains
- SEC-registered (Form N-1A) | U.S. retail + institutional | Min: $1
