...
# Oil Painting on Canvas — Deep Knowledge

Use this for tips on getting started with oil painting and getting really good. Benefit-led, concrete. For current workshops, ateliers, or supplies, use WEB_SEARCH and say when you looked it up.

---

## Why oil

Oil paint dries slowly (hours to days), which means you can push it around, blend, correct, and layer without pressure. No other medium gives you this forgiveness. Acrylics dry in minutes; watercolor is unforgiving. Oil rewards patience and lets you build paintings over multiple sessions. The Old Masters used oil for a reason — it does everything.
...
- **Palette knife** (medium, diamond shape): Mixing on palette, impasto, scraping.
- **Synthetic vs natural:** Synthetic (Escoda Versatil, Da Vinci Nova) are cheaper and handle well for beginners. Natural hog bristle (Escoda Classics) holds more paint for impasto. Both work.
...
- **Stand oil:** Very slow drying, super smooth, enamel-like. Mix small amounts into final layers.
...
- **Rags and disposal:** Cotton rags for wiping brushes. **Fire hazard:** oil-soaked rags can self-combust. Lay flat to dry or store in a sealed metal container. Never ball up and throw in a bin.
...
2. **Copy a master in grayscale:** Pick one painting (Vermeer, Rembrandt, Sargent). Copy it in burnt umber + white only. You'll learn composition, value structure, and edge quality.
...
2. **Still life from life:** Set up 2–3 objects on a table with a single light source. Paint from life — photos flatten color and lie about value. Work in 2–3 sessions: block-in → refine → finish.
...
2. **Alla prima:** Also practice direct painting (wet-into-wet, one session). Different skill — bold, decisive brushwork. Good for small studies and plein air.
...
- **Don't overwork.** If something looks right, stop touching it. "A painting is never finished — it merely stops in interesting places." — Paul Gardner.
- **Step back often.** Every 5–10 minutes, step back 2 meters. You'll see what the viewer sees. Up close, you see brushwork; from distance, you see the painting.
- **Tone your canvas.** Never paint on raw white. A thin wash of yellow ochre or raw umber takes 5 minutes and improves everything.
- **Big brush first.** Start with the biggest brush that makes sense. Smaller brushes come in at the end for detail. Beginners reach for small brushes too early — that's how you get tight, overworked paintings.
- **Paint shapes, not things.** Don't paint "an apple." Paint a dark red shape next to a warm highlight shape next to a cool shadow shape. The viewer's brain does the rest.
- **Clean palette, clean color.** Scrape and wipe your mixing area often. Muddy palette = muddy painting.
- **Photograph your work.** Take a phone photo after each session. Reviewing on screen shows value and composition errors you miss in person. Also: flip the photo horizontally — errors jump out.

---

## Southwest France context

- **Art supply in the region:** Dalbe (chains in Bordeaux, Bayonne) for basics. For premium (Old Holland, Michael Harding): order online (Jackson's Art Supplies UK, Géant des Beaux-Arts FR). Use WEB_SEARCH for current local options.
- **Plein air:** The Landes and Basque coast are exceptional for outdoor painting — ocean light, pine forests, the Dune du Pilat. Sorolla's beach paintings are the closest reference to what you see here.
- **Museums nearby:** Musée des Beaux-Arts de Bordeaux, Musée Basque (Bayonne — more cultural than fine art), Bilbao Guggenheim (~2h). For serious Old Masters: Prado in Madrid (day trip from Biarritz is ambitious but possible; better as a 2-day).
- **Workshops:** Look for ateliers in Bordeaux, Biarritz, or the Basque coast. Summer workshops sometimes run in the Landes. Use WEB_SEARCH for current offerings.

---

## What Kelly does with this

- Recommend starting with the limited palette and grisaille studies — concrete, not overwhelming.
- Suggest daily 20–30 min studies as the habit that makes the difference.
- Weave painting into rebalance suggestions: "Set up a still life and paint for an hour" is a screen-free, creative rebalance move.
- Reference Sorolla when talking about painting light and the coast. Reference Zorn for limited palette inspiration.
- Use WEB_SEARCH for current workshops, courses, or technique tutorials when they want to level up.
