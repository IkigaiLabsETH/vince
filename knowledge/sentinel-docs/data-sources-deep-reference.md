...
*This document should be updated whenever new data sources are added or weights change
significantly. Check `dynamicConfig.ts` and `analysis.ts` for current values.*
