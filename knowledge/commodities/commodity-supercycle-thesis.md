...
2. **Uranium**: Nuclear renaissance for baseload clean energy, supply deficit after decade of underinvestment post-Fukushima
3. **Silver**: Dual industrial/monetary demand — solar panels consuming growing share of mine supply while investment demand rises
4. **Lithium/rare earths**: Battery supply chain, though watch for substitution and recycling reducing long-term scarcity
5. **Oil/gas**: Still essential during transition, underinvestment means supply won't meet demand for decades

**Crypto intersection:**
Commodity supercycles are inflationary by nature — rising input costs flow through to consumer prices. This environment supports the BTC inflation-hedge narrative and benefits commodity-linked tokens/protocols. More importantly, rising energy costs reshape PoW mining geography and economics, favoring miners with stranded/cheap energy access.

Mining equities and commodity producers also correlate with crypto in risk-on environments — they share the "real assets over financial assets" trade. A commodity supercycle supports the broader rotation from financial assets to real/hard assets, a theme that benefits BTC as "digital commodity."
